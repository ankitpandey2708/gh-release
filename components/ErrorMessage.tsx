    ...
    <div className="p-6 bg-red-50 border border-red-200 rounded-md shadow-sm">
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1">
          <h3 className="text-h3 font-medium text-red-900 mb-1">Error</h3>
      ...
      {tips.length > 0 && (
        <div className="mt-4 mb-4 p-3 bg-red-100/50 rounded-md border border-red-200">
          <p className="text-body-sm font-medium text-red-900 mb-2">Suggestions:</p>
          <ul className="text-body-sm text-red-700 space-y-1">
            {tips.map(tip => (
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="px-4 py-2 bg-red-600 text-white font-medium text-body rounded-md hover:bg-red-700 transition-colors duration-200 shadow-sm hover:shadow-md"
        >
          Try again
        </button>
      )}
